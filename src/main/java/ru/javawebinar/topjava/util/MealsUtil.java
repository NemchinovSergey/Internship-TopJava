...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 8, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 12, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2015, Month.MAY, 30, 18, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 9, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 19, 0), "Ужин", 550)
    );
